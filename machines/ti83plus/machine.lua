...
local Timer = require("machines.ti83plus.hw.timer")
local Asic = require("machines.ti83plus.hw.asic")
...
function Machine:saveState()
  ...
  return SaveState.new(MACHINE_ID, {
    ...
    flash = SaveState.pack_bytes(self.flash.bytes, self.flash.SIZE or (0x4000 * 32)),
    flash_cmd = {
