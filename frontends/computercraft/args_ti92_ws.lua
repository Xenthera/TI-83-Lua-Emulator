...
function M.usage_text()
  return [[NAME
    ti92_cc_ws - TI-92 Plus advanced-monitor client over WebSocket

SYNOPSIS
    ti92_cc_ws --url ws://HOST:8765 [--lcd SIDE] [--pad SIDE]

DESCRIPTION
    Thin CC client. Emulation runs on LuaJIT
    (bridge/main.lua --machine ti92plus).
    LCD and keypad use separate advanced monitors (local
    in-CC build can use a combined face instead).
