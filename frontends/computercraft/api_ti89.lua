-- ComputerCraft-facing API for TI-89 Titanium (bundle entry point).
--
...
-- Shell:
--   test --help
--   ti89_cc --rom ti89titanium.rom

local Machine = require("machines.ti89.machine")
local CC = require("frontends.computercraft.cc")
local LcdView = require("frontends.computercraft.lcd_view_ti89")
local KeypadView = require("frontends.computercraft.keypad_view_ti89")
local Host = require("frontends.computercraft.host")
local Args = require("frontends.computercraft.args_ti89")
local Profile = require("frontends.computercraft.profile_ti89")
