-- ComputerCraft / bundle argv parser for TI-84 Plus.

local M = {}

function M.usage_text()
  return [[NAME
    ti84_cc - TI-84 Plus emulator for ComputerCraft

SYNOPSIS
    ti84_cc [OPTIONS] [lcd] [pad]

DESCRIPTION
    Boots a 1MB TI-84+ flash dump. Attach one or more advanced monitors;
...
OPTIONS
    ...
    --rom PATH
        1MB TI-84+ flash image (default: ti84plus.rom; also tries
        ti84p.rom / ti84.rom).
...
EXAMPLES
    ti84_cc
    ti84_cc --help
    ti84_cc --rom ti84p.rom
    ti84_cc --loadapp MyApp.8xk
    ti84_cc left right
...
NOTES
    ...
    Monitor roles are saved to ti84.prefs next to the program.
    Battery memory auto-saves to saves/ti84plus/ on quit.
]]
end
