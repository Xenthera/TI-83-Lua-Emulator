-- ComputerCraft-facing API for TI-92 Plus (bundle entry point).
--
--   local ti92 = dofile("ti92_cc.lua")
--   ti92.run({ rom = "ti92plus.rom" })
--
-- Shell:
--   test --help
--   ti92_cc --rom ti92plus.rom

local Machine = require("machines.ti92plus.machine")
local CC = require("frontends.computercraft.cc")
local LcdView = require("frontends.computercraft.lcd_view_ti92")
local KeypadView = require("frontends.computercraft.keypad_view_ti92")
local FaceView = require("frontends.computercraft.face_view_ti92")
local Host = require("frontends.computercraft.host")
local Args = require("frontends.computercraft.args_ti92")
local Profile = require("frontends.computercraft.profile_ti92")

local api = {}

api.VERSION = "0.1.0"
api.MACHINE_ID = "ti92plus"
api.LCD_WIDTH = LcdView.PIXEL_W or LcdView.NEED_W
api.LCD_HEIGHT = LcdView.PIXEL_H or LcdView.NEED_H

api.CC = CC
api.Machine = Machine
api.LcdView = LcdView
api.KeypadView = KeypadView
api.FaceView = FaceView
api.Profile = Profile
